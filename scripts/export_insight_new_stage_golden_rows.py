...
GOLDEN = BASE / 'insight_new_stage_bg_golden_30.jsonl'
RAW = BASE / 'insight_new_stage_bg_raw_traces.json'
OUT_ALL = BASE / 'insight_new_stage_bg_golden_30_rows.json'
OUT_DIR = BASE / 'insight_new_stage_bg_golden_30_rows'
